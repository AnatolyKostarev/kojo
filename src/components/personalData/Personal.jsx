    ...
    <div onClick={closePersonal} className={styles.personal}>
      <div className={styles.container}>
        <div
          ...
          className={styles.personal__agreement}
        >
          ...
          <div className={styles.personal__basic}>
            ...
            <dl>
              <dt className={styles.personal__paragraph}>
                Администрация Сайта обрабатывает Ваши персональные данные в
                целях, для которых они были предоставлены, в том числе:
              </dt>
              <dd className={styles.personal__paragraph}>
                · для регистрации запроса Пользователя на Сайте;
              </dd>
              <dd className={styles.personal__paragraph}>
                · для регистрации Пользователя на Сайте для предоставления
                расширенного доступа к функционалу Сайта;
              </dd>
              <dd className={styles.personal__paragraph}>
                · для направления Пользователю наших новостных и (или)
                информационных материалов, в т.ч. информации об Администрации
                Сайта, наших услугах, мероприятиях;
              </dd>
              <dd className={styles.personal__paragraph}>
              ...
              <dd className={styles.personal__paragraph}>
                · для выполнения обязанностей, установленных для Администрации
                Сайта законодательством Российской Федерации;
              </dd>
              <dd className={styles.personal__paragraph}>
            ...
            <p className={styles.personal__paragraph}>
              Администрация Сайта принимает необходимые правовые,
            ...
            <p className={styles.personal__paragraph}>
              ...
              безопасности персональных данных и назначает лицо, ответственное
            ...
            <p className={styles.personal__paragraph}>
              ...
              персональных данных, если иной срок хранения персональных данных
            ...
            <p className={styles.personal__paragraph}>
              ...
              если обеспечить правомерность обработки невозможно; по истечении
              срока действия согласия Пользователя на обработку персональных
              данных; в случае ликвидации Администрации Сайта; в иных случаях,
              предусмотренных законом.
            </p>
          </div>
          <div onClick={closePersonal}>
            <Button title="принять" addStyle="personal_btn" />
          </div>
        </div>
      </div>
    </div>
