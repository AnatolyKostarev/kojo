...
export default function HomePageMobile() {
  ...
  const handleHeader = () =>
    window.scrollY > 100 ? setColor(false) : setColor(true);
      ...
      <main>
        ...
        <section className={styles.about}>
          ...
          <div className={styles.awards}>
            <div className={styles.block_title}>
              <h3>AWARDS</h3>
              <p>our achiievements</p>
            </div>
            <div className={styles.block_content}>
              <div className={styles.lists}>
                <div className={styles.list_title}>AWWWARDS:</div>
                <p className={styles.text_bld}>1X SITE OF THE DAY</p>
              </div>
              <div className={styles.lists}>
                <p className={styles.text_bld}>8X HONORABLE MENTION</p>
              </div>
              <div className={styles.lists}>
                <div className={styles.list_title}>BEHANCE:</div>
                <p className={styles.text_bld}>6X FEATURED IN INTERACTION</p>
              </div>
              <div className={styles.lists}>
